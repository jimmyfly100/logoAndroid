...
public class CanvasView extends View implements ICanvas{
    ...
    private void initCanvas() {
        ...
        bitmap = Bitmap.createBitmap(viewWidth, viewHeight, Bitmap.Config.ARGB_4444);//设置位图的宽高
        ...
        turtleBmp = Bitmap.createBitmap(viewWidth, viewHeight, Bitmap.Config.ARGB_4444);//设置位图的宽高
